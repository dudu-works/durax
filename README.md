...
마우스를 올리면 뛰지 않고 정면으로 눈을 맞춘 채 입을 양옆으로 넓게 벌립니다. 입 폭은 높이보다 명확히 크고, 위아래 개구는 중간 크기로 제한했습니다. hover 뒤에는 자연스러운 짧고 넓은 비율로 쪼그린 채 혀 길이만 왕복합니다.
...
- 마우스 hover 시 세로 O가 아닌 가로로 넓고 높이가 낮은 wide A 동작
