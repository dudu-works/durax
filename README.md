...
마우스를 올리면 뛰지 않고 정면으로 눈을 맞춘 채 입을 양옆으로 넓게, 위아래로도 크게 벌립니다. 입 외곽은 양쪽이 둥글고 중앙이 조금 잘록한 넓은 직사각형입니다. hover 뒤에는 와와 동작 대신 쪼그린 채 혀를 짧게 내밀었다가 조금 더 길게 내미는 동작을 반복합니다.
...
- 마우스 hover 시 양옆과 위아래 공간이 모두 큰 무한대형 wide A 동작
