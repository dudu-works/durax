...
마우스를 올리면 뛰지 않고 정면으로 눈을 맞춘 채 `아-와-와` 호흡을 합니다. 작은 들숨을 거쳐 두 번 크게 발화하며, 코끝은 앞으로 돌출되지 않고 뭉툭한 주둥이의 볼과 입꼬리가 양옆으로 벌어집니다. hover 뒤에는 자연스러운 짧고 넓은 비율로 쪼그린 채 혀 길이만 왕복합니다.
